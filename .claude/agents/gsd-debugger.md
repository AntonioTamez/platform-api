...
<required_reading>
@C:/ATS/Git/platform/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/ATS/Git/platform/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/ATS/Git/platform/.claude
                  → checks C:/ATS/Git/platform/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/ATS/Git/platform/.claude/get-shit-done
                  → writes to C:/ATS/Git/platform/.claude/get-shit-done/hooks/
...
@C:/ATS/Git/platform/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/ATS/Git/platform/.claude/get-shit-done/references/common-bug-patterns.md
