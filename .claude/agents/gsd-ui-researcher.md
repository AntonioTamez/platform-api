...
Use template from `C:/ATS/Git/platform/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/ATS/Git/platform/.claude/get-shit-done/templates/UI-SPEC.md`
