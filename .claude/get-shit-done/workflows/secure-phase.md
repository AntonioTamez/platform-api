...
```
Agent(
  prompt="Read C:/ATS/Git/platform/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/ATS/Git/platform/.claude/get-shit-done/templates/SECURITY.md`
