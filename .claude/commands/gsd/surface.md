...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/ATS/Git/platform/.claude/.gsd-surface.json`
(sibling to `C:/ATS/Git/platform/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/ATS/Git/platform/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/ATS/Git/platform/.claude/skills`).
...
`C:/ATS/Git/platform/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/ATS/Git/platform/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/ATS/Git/platform/.claude/.gsd-surface.json`
Install profile marker: `C:/ATS/Git/platform/.claude/.gsd-profile`
Skill dirs: `C:/ATS/Git/platform/.claude/skills/gsd-*/`
Engine module: `C:/ATS/Git/platform/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/ATS/Git/platform/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
